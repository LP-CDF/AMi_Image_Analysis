...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableViewProject.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableViewProject.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableViewProject.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableViewProject.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableViewProject.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableViewProject.setHorizontalHeaderItem(5, item)
...
"for Well"))
        ...
        item = self.tableViewProject.horizontalHeaderItem(0)
